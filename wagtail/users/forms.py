...
class UserForm(UsernameForm):
    ...
    bio= forms.CharField(required=True, label=_("Bio"))

    facebook_url = forms.URLField(required=False, label=_("Facebook"))
    twitter_url = forms.URLField(required=False, label=_("Twitter"))
    instagram_url = forms.URLField(required=False, label=_("Instagram"))
    threads_url = forms.URLField(required=False, label=_("Threads"))
    linkedin_url = forms.URLField(required=False, label=_("LinkedIn"))
    youtube_url = forms.URLField(required=False, label=_("Youtube"))
